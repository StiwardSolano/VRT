...
public class OVRGrabbable : MonoBehaviour
{
	...
	virtual public void GrabBegin(OVRGrabber hand, Collider grabPoint)
    {
        ...
        //Debug.Log("LTrigger index: " + OVRInput.Get(OVRInput.Axis1D.PrimaryIndexTrigger, OVRInput.Controller.LTouch));
        //Debug.Log("LTrigger hand: " + OVRInput.Get(OVRInput.Axis1D.PrimaryHandTrigger, OVRInput.Controller.LTouch));

        foreach (GrabCallback callback in GetComponents<GrabCallback>())
        {
            callback.OnGrab();
        }
    }
	...
	virtual public void GrabEnd(Vector3 linearVelocity, Vector3 angularVelocity)
    {
        ...
        //Debug.Log("LTrigger hand: " + OVRInput.Get(OVRInput.Axis1D.PrimaryHandTrigger, OVRInput.Controller.LTouch));
        /*
        foreach (GrabEndCallback callback in GetComponents<GrabEndCallback>())
        {
            callback.OnGrabEnd();
        }*/
        if (m_grabbedBy == null)
